...
**Тестирование**
Написание модульных тестов для компонентов авторизации и AI-сервиса. Проверка краевых случаев и обработки ошибок.
...
Моя работа над проектом началась с фундаментальной настройки окружения. Согласно чек-листам **Week 1** и **Week 2**, я развернула проект с использованием современного стека: **TypeScript**, **Vite** для быстрой сборки и **Firebase** в качестве бэкенда.
...
- **API:** Интеграция с внешним AI-провайдером через `fetch`.
- **Тестирование:** Vitest/Jest для покрытия критической логики тестами.
